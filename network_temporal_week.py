...
with open('network_temporal_week.csv', 'r', newline='') as file:
    ...
    for row in csv_reader:
        ...
        cursor.execute("""
            INSERT INTO network_temporal_week_belfast (from_stop_I, to_stop_I, dep_time_ut, arr_time_ut, route_type, trip_I, seq, route_I)
